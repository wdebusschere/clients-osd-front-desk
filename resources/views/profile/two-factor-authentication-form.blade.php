    ...
    <x-slot:content>
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                ...
                @if ($showingConfirmation)
                    <div class="mt-4">
                        ...
                        <x-forms.input id="code" type="text" name="code" class="block w-1/2" inputmode="numeric" autofocus autocomplete="one-time-code"
                            wire:model="code"
            ...
            @if ($showingRecoveryCodes)
                ...
                <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 dark:bg-gray-900 dark:text-slate-100 rounded-lg">
