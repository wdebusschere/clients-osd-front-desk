    ...
    <div x-data="{ recovery: false }">
        ...
        <form method="POST" action="{{ route('two-factor.login') }}">
            ...
            <div class="mt-4" x-show="! recovery">
                ...
                <x-forms.input id="code" class="block w-full" type="text" inputmode="numeric" name="code" autofocus
                               x-ref="code" autocomplete="one-time-code"/>
            </div>

            <div class="mt-4" x-cloak x-show="recovery">
                <x-forms.label for="recovery_code" value="{{ __('Recovery Code') }}"/>
                <x-forms.input id="recovery_code" class="block w-full" type="text" name="recovery_code"
