...
return [
    ...
    | classe validadora. Algumas dessas regras têm versões múltiplas, como as regras de tamanho.
    ...
    */
    ...
    'contains' => 'O campo :attribute está a faltar um valor requerido.',
    ...
    | usando a convenção "atributo.regra" para nomear as linhas. Isto torna rápido
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar o espaço reservado do nosso atributo
    | por algo mais amigável ao leitor, como "Endereço de E-Mail" em vez de "email".
    | Isto simplesmente ajuda a tornar a nossa mensagem mais expressiva.
    |
    */
